...
urlpatterns = [
    ...
    path("password-change-done/", auth_view.PasswordChangeDoneView.as_view(template_name="app/passwordchangedone.html"), name="passwordchangedone"),
...
admin.site.site_header = "EG Music Shop"
admin.site.site_title = "EG Music Shop"
admin.site.site_index_title = "Welcome EG Music Shop"